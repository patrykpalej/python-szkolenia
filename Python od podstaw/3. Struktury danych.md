...
---
Możliwe jest również wyciąganie przedziałów podając początek (*start*) i/lub koniec (*stop*) a także wyciąganie co któregoś elementu za pomocą kroku (*step*). Działa to według poniższego schematu:
```
a[start:stop]  
a[start:]      
a[:stop]       
...
```
[0, 2, 4, 6, 8]
Od początku do końca co drugi elementu
