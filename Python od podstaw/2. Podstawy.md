...
#### `len`
Służy do sprawdzenia długości obiektów, które są sentencjami. Przykładem takiego obiektu jest zmienna tekstowa (string) oraz różnego rodzaju [[Python od podstaw/3. Struktury danych|struktury danych]].
