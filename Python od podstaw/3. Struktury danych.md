...
Przykładem może być struktura, w której znajdują się infromacje na temat symulowanych postaci:
```python
...
```
Zwraca ona "listę" wartości: `dict_values(['Zombie', 1.2, -4.32, 2.4, 3, 10, True, None])`
---
---
---
&nbsp;
