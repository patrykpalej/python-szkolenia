...
W wielu językach programowania istnieją tzw. komentarze blokowe, czyli takie które obejmują więcej niż jedną linię kodu. W Pythonie nie istnieją takie komentarze, ale ich rolę mogą spełniać wielolinijkowe stringi nie przypisane do zmiennej. Aby utworzyć wielolinijkowego stringa używamy potrójnych cudzysłowów (lub apostrofów):
