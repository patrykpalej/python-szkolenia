### 8.1 Wprowadzenie
Wyrażeń regularnych używamy wtedy, kiedy chcemy znaleźć w tekście fragmenty o określonym wzorcu, ale nie wskazując dosłownie jaki ciąg znaków nas interesuje. Poniżej dwa przykłady:
