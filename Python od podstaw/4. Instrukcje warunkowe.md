...
*else* - w bloku kodu, który znajdzie się pod *else* znajdują się instrukcje, które mają zostać wykonane w pozostałym przypadku to znaczy jeśli żaden z powyższych warunków nie został spełniony. Ten element jest opcjonalny, nie musimy definiować bloku *else*
