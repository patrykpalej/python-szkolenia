...
Robimy to w następujacy sposób. Zacznijmy od stworzenia klasy `Vehicle`, która będzie reprezentować dowolny pojazd. Każdy pojazd ma jakiś kolor, wagę oraz przebieg. Ma też możliwość przejechania pewnego dystansu, czyli zwiększenia przebiegu.
