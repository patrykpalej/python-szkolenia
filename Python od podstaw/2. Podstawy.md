...
Innym zastosowaniem komentarzy, którego również nie powinno się nadużywać jest komentowanie fragmentów kodu, którego tymczasowo nie planujemy używać ale nie chcemy go też trwale usuwać. Jest to przydatne na etapie testowania i eksperymentowania, ale na dłuższą metę zakomentowany kod nie powinien znajdować się w repozytorium (czyli "miejscu" gdzie składowany jest kod). 
