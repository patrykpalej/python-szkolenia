...
Tym zapytanie dodajemy dane do tabeli a dokładnie to tworzymy nowy wiersz. Możemy, ale nie musimy określać wartości dla każdej kolumny. Jeśli chcemy dodać kompletny wiersz robimy to w taki sposób:
