...
Taką funkcję możemy utworzyć jak zwykły obiekt - przypisując do zmiennej - a następnie wywołać. Zwykle jednak tego nie robimy. Inna nazwa lambdy to "funkcja anonimowa" co oznacza że nie ma ona nazwy, a jedynie przekazujemy ją jako argument do innej funkcji. 
