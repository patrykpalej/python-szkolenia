...
#### 3.8.1 `zip`
Generator `zip` służy do łączenia w pary elementów z dwóch lub więcej sekwencji. Działa na podobnej zasadzie co zamek błyskawiczny:
```python
x_coordinates = [2, 5, 3]
y_coordinates = [3, 6, 1]
...
Samo wywołanie zipa zwróci mniej więcej taki wynik: `<zip at 0x7f1c15715300>`. Jeśli jednak zrzutujemy go na listę:
```python
...
- Oba te generatory mogą posłużyć m.in. do utworzenia słownika a także są przydatne w [[5. Pętle|pętlach]]
---
---
---
&nbsp;
